...
function sincronizarRama() {
    ...
    const btn = document.getElementById('btnSincronizar');
    btn.disabled = true;
    btn.innerHTML = `<i class="fas fa-spinner fa-spin"></i> Consultando ${cfg.label}...`;
    ...
    fetchWithAuth(`/procesos_juridicos/backend/controllers/${cfg.controller}`,
        ...
        .finally(() => {
            ...
            btn.disabled = false;
            const cfg2 = FUENTES[fuenteActual] || FUENTES.rama;
            btn.style.background = cfg2.color;
            btn.innerHTML = `<i class="fas fa-sync-alt"></i> ${cfg2.label}`;
        });
}
